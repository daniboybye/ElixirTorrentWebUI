defmodule ElixirTorrentWebUIWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElixirTorrentWebUIWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElixirTorrentWebUIWeb.Gettext, "errors", msg, opts)
    end
  end
